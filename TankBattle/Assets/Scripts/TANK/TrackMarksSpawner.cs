...
{
    private Vector2 lastPosition;//vị trí cuối cùng
    public float trackDistance = 0.2f;//khoảng cách của mỗi track đó(vệt bánh xe)
    public GameObject trackPrefab;
    public int objectPoolSize = 50;

    private ObjectPool objectPool;//object pooling
